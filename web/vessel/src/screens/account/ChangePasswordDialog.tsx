...
// user menu. ForcedPasswordChange (the full-page variant shown right
// after a Master-issued temporary password, architecture 9.2) is a
// separate component with its own layout, not this Dialog — but shares
// the same field shape and passwordStrength helper.
