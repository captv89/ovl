 ...
 *
 * `filterSlot` renders between the title and the icon `actions` — for a
 * single contextual control that narrows the whole app (e.g. a global
 * group/scope filter pill), not a general pre-actions children slot.
 ...
 */
export function TopAppBar({ title, leadingIcon = "menu", onLeadingClick, actions = [], filterSlot = null, trailing = null, style }) {
  return (
    <div
      style={{
        display: "flex",
